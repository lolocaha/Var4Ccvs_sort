...
def report1(owners):#Меню для 1 задания
    ...
    print('2Сначала сортировка по году постановки на учет (по убыванию) , а затем по фамилиям (по возрастанию)')
    def task1(a,b):
...
def report2(owners): #Меню для 2 задания
    ...
    if len(vaz_owners)  == 0:#если список пустой, то выведет, что таких автомобилистов нет
        ...
        bubble_sort(vaz_owners,task2)#сортируем и выводим значени
